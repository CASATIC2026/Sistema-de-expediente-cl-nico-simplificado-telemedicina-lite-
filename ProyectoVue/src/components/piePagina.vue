...
<template>
  <footer class="bg-slate-900 text-slate-400 py-10 px-6 border-t border-white/5">
    <div class="max-w-6xl mx-auto flex flex-col items-center gap-6">
      ...
      <div class="text-center text-[10px] opacity-50">
        <p>&copy; 2026 Empresa XYZ. Todos los derechos reservados.</p>
      </div>
    </div>
  </footer>
</template>
...
<style scoped>
/* Estilos específicos si los necesitas más adelante */
</style>