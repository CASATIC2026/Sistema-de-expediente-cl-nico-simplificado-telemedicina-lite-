...
namespace TelMedAPI.Controllers
{
    ...
    public class CitasController : ControllerBase
    {
        ...
        // =========================================================
        // DOCTOR Y ADMIN TIENEN ACCESO AL HISTORIAL DEL PACIENTE
        // =========================================================
       ...
       // =========================================================
        ...
        // =========================================================
        // Actualizar horarios de doctor (solo Admin)
        // =========================================================
        [Authorize(Roles = Roles.Admin)]
            ...
            [FromQuery] string fecha)
        {
            ...
            // Si no hay horario activo ese día muestra lista vacía
            if (horario == null)
            ...
            {
                // Convertir slot local (UTC-6) a UTC para comparar con la BD
