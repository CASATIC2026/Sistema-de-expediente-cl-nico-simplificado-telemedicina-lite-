...
<template>
  ...
  <div
    class="fixed top-0 right-0 h-full z-9999
           ...
           w-full sm:w-112.5
           border-l border-slate-200 dark:border-cyan-500/20
  ...
  >
      ...
      <div
        class="p-6
               ...
               dark:from-[#0f2040] dark:to-[#10284f]"
      >

        <div>
          <h3 class="text-2xl font-bold text-slate-800 dark:text-white tracking-wide">
            Centro de Ayuda
          </h3>

          <p class="text-sm text-slate-500 dark:text-cyan-200/70 mt-1">
        ...
        <button
          @click="$emit('cerrar')"
          class="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-full bg-red-500/10 hover:bg-red-500/20 border border-red-400/20 text-red-400 hover:text-red-300 text-2xl md:text-3xl transition-all leading-none shrink-0"
        >
          &times;
        </button>
      ...
      >
        ...
        >
          ...
          <!-- TITULO CATEGORIA -->
          <h4
            class="flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em]
                   text-cyan-700 dark:text-cyan-400 ml-1"
          >
            ...
            <details class="group">
              ...
              >
                ...
                <span class="transition group-open:rotate-180 shrink-0 ml-2">
                  <i class="fa-solid fa-chevron-down text-xs text-cyan-500 dark:text-cyan-400"></i>
                </span>
      ...
      <div
        class="p-6
               ...
               bg-slate-50 dark:bg-[#0f2040]
               space-y-4"
      >

        <p class="text-sm font-semibold text-slate-700 dark:text-white text-center">
          ¿Aún necesitas ayuda?
        </p>
        ...
        <div class="grid grid-cols-2 gap-3">
          ...
          <a
            ...
            class="flex items-center justify-center gap-2 px-4 py-3
                   ...
                   transition-all"
          >
            <i class="fa-solid fa-phone text-cyan-500 dark:text-cyan-400"></i>
            Llamar
          </a>
