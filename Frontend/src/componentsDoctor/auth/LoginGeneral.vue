...
<template>
  <div class="w-full max-w-md p-4 text-white md:p-8">
    ...
    <form @submit.prevent="handleLogin" class="space-y-5 md:space-y-6" :class="{'opacity-50 pointer-events-none': cargando}">
      ...
      <div>
        ...
        <div class="mt-1 text-right">
          <button
            ...
            class="text-[11px] text-cyan-400/70 hover:text-cyan-300 uppercase tracking-widest transition-colors touch-manipulation cursor-pointer"
          >
      ...
      <button
        type="submit"
        class="w-full py-3.5 md:py-4 bg-cyan-600 hover:bg-cyan-500 active:bg-cyan-700 text-white font-bold rounded-xl transition-all active:scale-[0.98] shadow-lg shadow-cyan-950/20 uppercase tracking-[0.2em] text-sm touch-manipulation cursor-pointer"
      >
        INICIAR
      </button>
