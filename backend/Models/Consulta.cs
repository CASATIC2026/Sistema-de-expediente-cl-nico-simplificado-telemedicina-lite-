...
namespace TelMedAPI.Models
{
    ...
    public class Consulta
    {
        ...
        [Column("tiene_orden_laboratorio")]
        public bool TieneOrdenLaboratorio { get; set; }

        [Column("examenes_json")]
        public string ExamenesJson { get; set; } = string.Empty;

        // "Pendiente" | "ResultadosSubidos" | "Revisado"
        [Column("estado_orden")]
        public string EstadoOrden { get; set; } = string.Empty;

        [Column("resultado_pdf_path")]
        public string? ResultadoPdfPath { get; set; }

        [Column("observaciones_laboratorio")]
        public string ObservacionesLaboratorio { get; set; } = string.Empty;
    }
}