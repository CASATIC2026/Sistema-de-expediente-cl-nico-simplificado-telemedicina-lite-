...
namespace TelMedAPI.Services
{
    public class EmailService
    {
        ...
        // =========================================================
        // NOTIFICACIÓN: DOCTOR REVISÓ RESULTADOS DE LABORATORIO
        // =========================================================
        public async Task EnviarNotificacionRevisionLaboratorio(
            string destino,
            string nombrePaciente,
            string nombreDoctor)
        {
            var html = $@"
                <div style='font-family: Arial, sans-serif;'>
                    <h2>Tus exámenes han sido revisados - TelMed™</h2>

                    <p>Hola {nombrePaciente},</p>

                    <p>
                        El/La <strong>Dr(a). {nombreDoctor}</strong> ha revisado los resultados
                        de tus exámenes de laboratorio y ha dejado sus observaciones médicas.
                    </p>

                    <p>
                        Ingresa a tu portal TelMed™ y dirígete a 
                        <strong>Mis Citas → Finalizadas</strong> para ver
                        las observaciones de tu médico.
                    </p>
            ...
            await EnviarCorreo(
                destino,
                "El doctor revisó tus exámenes de laboratorio - TelMed™",
                html
            );
        }
