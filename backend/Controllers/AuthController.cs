...
public class AuthController : ControllerBase
{
                ...
                if (string.IsNullOrEmpty(user.PasswordHash))
                    {
                        return BadRequest(new
                        {
                            message = "Esta cuenta no tiene contraseña definida. Utiliza Google para iniciar sesión."
                        });
                    }
        ...
        if (string.IsNullOrEmpty(user.PasswordHash))
            {
                return BadRequest(new
                {
                    message = "Esta cuenta no tiene contraseña definida."
                });
            }
    ...
    public async Task<IActionResult> Perfil()
    {
        ...
        var user = await _context.Usuarios
            ...
            .Select(u => new { u.Nombre, u.Apellido, u.Email, u.Rol, u.FotoUrl, u.AvatarIcono })
            .FirstOrDefaultAsync();
